...
OUTPUT_PNG = OUTPUT_DIR / "case6_f4_style_comparison.png"
OUTPUT_PDF = OUTPUT_DIR / "case6_f4_style_comparison.pdf"
...
def set_left_row_label(ax, field_key: str) -> None:
    ...
    ax.set_ylabel(label, fontsize=10, rotation=0, labelpad=24, va="center", ha="right")
...
def set_square_plot_box(ax) -> None:
    ax.set_box_aspect(1)
...
def plot_loss_panel(fig: plt.Figure, spec) -> None:
    ...
    ax.set_title("Case 6", fontsize=9, pad=3)
...
def plot_comparison_figure(
    ...
    fig.suptitle("Case 6: F4-style comparison", fontsize=13, y=0.985)
    ...
    fig.subplots_adjust(left=0.085, right=0.986, top=0.963, bottom=0.055)
    return fig
